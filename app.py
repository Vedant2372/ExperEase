...
app = Flask(__name__)
# CORS: web (5173), Expo (8081), mobile (null), Android emulator
CORS(app, resources={r"/*": {"origins": ["http://localhost:5173", "http://127.0.0.1:5173", "http://localhost:8081", "http://localhost:19006", "null"]}})
